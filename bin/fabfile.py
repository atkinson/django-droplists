...
env.hosts = ['djangoproject.example.com']
env.code_dir = '/srv/www/djangoproject'
env.virtualenv = '/srv/www/djangoproject/.virtualenv'
env.code_repo = 'git@github.com:user/djangoproject.git'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/djangoproject/wsgi.py" % env.code_dir)
